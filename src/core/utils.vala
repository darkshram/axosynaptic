...
{
  [CCode (gir_namespace = "AxoSynapticUtils", gir_version = "1.0")]
  namespace Utils
  {
    ...
    public static string extract_type_name (Type obj_type)
    {
      ...
      if (obj_class.has_prefix ("AxoSynaptic")) return obj_class.substring (7);
    ...
    public class Logger
    {
      ...
      public static void initialize ()
      {
        ...
        if (Environment.get_variable ("AXOSYNAPTIC_DEBUG") != null)
