...
namespace AxoSynaptic
{
  ...
  public abstract class SearchMatch : Match, SearchProvider
  {
    ...
    public abstract async Gee.List<AxoSynaptic.Match> search (string query, AxoSynaptic.QueryFlags flags, AxoSynaptic.ResultSet? dest_result_set, GLib.Cancellable? cancellable = null) throws AxoSynaptic.SearchError;
  }
