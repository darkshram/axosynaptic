...
namespace AxoSynaptic
{
  public class HybridSearchPlugin : Object, Activatable, ItemProvider
  {
    ...
    {
      data_sink.search_done["AxoSynapticZeitgeistPlugin"].connect (this.zg_plugin_search_done);
    }
    ...
    public async ResultSet? search (Query q) throws SearchError
    {
      ...
      if (data_sink.is_plugin_enabled (Type.from_name ("AxoSynapticZeitgeistPlugin")))
      {
