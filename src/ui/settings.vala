  ...
  public class SettingsWindow : Gtk.Window
  {
    class PluginTileObject : UI.Widgets.AbstractTileObject
    {
      ...
      construct
      {
        ...
        if (pi.plugin_type.is_a (typeof (AxoSynaptic.Configurable)))
        {
    ...
    {
      this.title = _("AxoSynaptic - Settings");
    ...
    private void init_themes ()
    {
      ...
      themes["default"] = Theme (_("Default"), "", typeof (AxoSynaptic.Gui.ViewDefault));
      themes["essential"] = Theme (_("Essential"), "", typeof (AxoSynaptic.Gui.ViewEssential));
      themes["doish"] = Theme (_("Doish"), "", typeof (AxoSynaptic.Gui.ViewDoish));
      themes["side-doish"] = Theme (_("Side Doish"), "", typeof (AxoSynaptic.Gui.ViewSideDoish));
      themes["virgilio"] = Theme (_("Virgilio"), "", typeof (AxoSynaptic.Gui.ViewVirgilio));
    ...
    private void build_ui ()
    {
      ...
      behavior_vbox.pack_start (notification, true);
