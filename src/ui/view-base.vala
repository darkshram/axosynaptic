...
{
  /* Gtk+-3.0 base class */
  public class Gui.View : Gtk.Window, AxoSynaptic.Gui.IView
  {
    ...
    static construct
    {
      var bg_style = new GLib.ParamSpecBoolean ("use-selected-color",
                                                "Use selected color",
                                                "Use selected color for the background of AxoSynaptic in supported themes",
                                                false,
                                                GLib.ParamFlags.READWRITE);

      var border_radius = new GLib.ParamSpecInt ("border-radius",
                                                 "Border Radius",
                                                 "Border Radius of AxoSynaptic window",
                                                 0, 50, 12,
                                                 GLib.ParamFlags.READWRITE);
      var shadow_size = new GLib.ParamSpecInt ("shadow-size",
                                               "Shadow Size",
                                               "Shadow size of AxoSynaptic window",
                                               0, 50, 13,
                                               GLib.ParamFlags.READWRITE);
    ...
    protected AxoSynaptic.Gui.Model model = null;

    public AxoSynaptic.Gui.Model controller_model { get; construct set; }
    public AxoSynaptic.Gui.IController controller { get; construct set; }
