...
namespace AxoSynaptic.Gui
{
  ...
  public class MenuButton : FakeButton
  {
    ...
    public MenuButton ()
    {
      ...
      item.activate.connect (() => {
        var about = new AxoSynapticAboutDialog ();
        about.run ();
        about.destroy ();
      });
      menu.append (item);
  ...
  public class AxoSynapticAboutDialog : Gtk.AboutDialog
  {
    public AxoSynapticAboutDialog ()
    {
      ...
      GLib.Object (artists : artists,
                   ...
                   program_name: "AxoSynaptic",
                   logo_icon_name : "axosynaptic",
                   version: Config.VERSION + "\n" + Config.RELEASE_NAME,
                   website: "http://launchpad.net/axosynaptic-project");
    }
  }
