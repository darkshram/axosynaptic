...
namespace AxoSynaptic.Gui
{
  ...
  public interface IController : Object
  {
    ...
    /* Events called by AxoSynaptic-Main */
    ...
    /* Tells at axosynaptic main, that the user wants to configure axosynaptic */
  ...
  public interface IView : Object
  {
    ...
    public abstract AxoSynaptic.Gui.Model controller_model { get; construct set; }
    public abstract AxoSynaptic.Gui.IController controller { get; construct set; }
